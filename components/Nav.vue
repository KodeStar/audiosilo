<template>
  <div
    ...
    class="transition-all z-40 bg-gray-200 dark:bg-gray-800 flex-shrink-0 flex-grow-0 w-screen transform lg:block lg:w-80 h-14 lg:h-full border-r border-gray-300 dark:border-gray-900 fixed bottom-0 lg:relative leftbar">
    ...
    <div class="lg:border-t border-gray-100 dark:border-gray-750 lg:p-8 px-2 lg:px-6 flex lg:flex-col justify-between lg:justify-start">
