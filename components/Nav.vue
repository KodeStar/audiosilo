<template>
  <div :class="{ '-translate-x-full': !menu, 'translate-x-0': menu }" class="transition-all z-40 bg-gray-100 flex-shrink-0 flex-grow-0 w-screen transform lg:translate-x-0 lg:w-80 p-8 px-6 h-(screen-80) lg:h-(screen-96) border-r border-gray-200 absolute inset-0 lg:relative">
    ...
    <NuxtLink class="flex items-center my-2 p-3 px-5 rounded-lg nav active" to="/">
      <i class="fa-light fa-rectangle-vertical-history mr-2 fa-lg"></i>
      Library
    </NuxtLink>
    <NuxtLink class="flex items-center my-2 p-3 px-5 rounded-lg nav" to="/settings">
      <i class="fa-light fa-gear mr-2 fa-lg" />
      Settings
    </NuxtLink>
    <NuxtLink class="flex items-center my-2 p-3 px-5 rounded-lg nav" to="/cached">
      <i class="fa-light fa-box-archive mr-2 fa-lg"></i>
      Cached
    </NuxtLink>
    <div class="flex cursor-pointer absolute bottom-0 left-0 border-t border-gray-200 w-full items-center p-5 px-10" @click="logout">
