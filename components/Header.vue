<template>
  <div class="sticky top-0 flex flex-col items-top lg:h-screen w-full">
    <div class="flex items-center w-full h-20 lg:h-24 border-b border-gray-300 dark:border-gray-900 lg:border-b-0 relative">
      <div class="lg:w-80 flex-shrink-0 flex-grow-0 lg:border-r lg:border-b border-gray-300 dark:border-gray-900 p-3 px-6 lg:px-8 h-20 lg:h-24 flex items-center">
        <NuxtLink class="flex items-center" to="/">
          <svg class="w-16 lg:w-18 mr-4 transform rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="299.2254999999999 397.8038000000001 401.5409999999997 315.357">
          ...
          <div class="flex flex-col">
            <div class="font-semibold text-2xl uppercase text-pink-600 leading-none">
              Audio<span class="font-bold text-gray-600 dark:text-gray-400">Silo</span>
            </div>
      ...
      <div :class="{ mobilesearch: search, flex: search }" class="px-0 lg:px-12 w-full items-center flex items-center lg:border-l border-gray-100 dark:border-gray-750 h-20 lg:h-24">
        ...
        <div :class="{ hidden: search }" class="flex lg:hidden justify-end text-lg mr-1">
          ...
          <div @click="menu = !menu" class="bg-gray-200 dark:bg-gray-800 rounded w-10 h-10 flex justify-center items-center mx-1">
