<template>
  <div class="flex flex-col items-top h-screen w-full">
    <div class="flex items-center w-full h-20 lg:h-24 border-b border-gray-200 lg:border-b-0 border-gray-200 relative">
      <div class="lg:w-80 flex-shrink-0 flex-grow-0 lg:border-r lg:border-b p-3 px-10 h-20 lg:h-24 flex items-center">
        <NuxtLink class="flex items-center" to="/">
          <svg
            class="svg-inline--fa fa-computer-speaker fa-w-20 fa-2xl mr-2"
            aria-hidden="true"
            focusable="false"
            data-prefix="fal"
